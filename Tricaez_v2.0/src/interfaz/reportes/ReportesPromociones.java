...
import bl.reportes.ReportesPromocionesBl;
 ...
 * @author mavg
 */
public class ReportesPromociones extends javax.swing.JInternalFrame {

    SesionEntity sesion;
    ReportesPromocionesBl bl = new ReportesPromocionesBl();
    PromocionesBl blNew = new PromocionesBl();
    Utilidades u = new Utilidades();
    String jasper1 = "promoSimple.jasper";
    String jasper2 = "promoGrupo.jasper";
    ...
    public ReportesPromociones(SesionEntity sesion) {
        this.sesion = sesion;
        initComponents();
        mapeoTeclas();
        seleccion();
    ...
    private Boolean valida(){
        if(rbtnPromocion.isSelected()){
            if(txtFolio.getText().length()==0){
                ...
                JOptionPane.showInternalMessageDialog(this,"El número de Promoción no existe","Aviso",JOptionPane.INFORMATION_MESSAGE);
                return false;
            }else{
                return true;
            }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("Reportes de Promociones");
        setFrameIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/Mazo.jpg"))); // NOI18N

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/repoPromociones.jpg"))); // NOI18N
        ...
        rbtnPromocion.setText("Información de Promoción");
        ...
        rbtnListado.setText("Listado de Promociones por Año");
