...
import bl.reportes.ReportesResolucionesBl;
 ...
 * @author mavg
 */
public class ReportesResoluciones extends javax.swing.JInternalFrame {

    SesionEntity sesion;
    ReportesResolucionesBl bl = new ReportesResolucionesBl();
    RegistroResolucionesBl blNew = new RegistroResolucionesBl();
    Utilidades u = new Utilidades();
    String jasper1 = "resolucionSimple.jasper";
    String jasper2 = "resolucionGrupo.jasper";
    Calendar cal = Calendar.getInstance(TimeZone.getDefault());
    
    /**
     * Creates new form ArchivarExpedientes
     */
    public ReportesResoluciones() {
        initComponents();
    }

    public ReportesResoluciones(SesionEntity sesion) {
        this.sesion = sesion;
        initComponents();
        mapeoTeclas();
        seleccion();
    ...
    private Boolean valida(){
        if(rbtnPromocion.isSelected()){
            if(txtFolio.getText().length()==0){
                ...
                txtFolio.requestFocus();
                return false;
            }else if(blNew.getResolucion(new Integer(txtFolio.getText()), getAnio())==null){
                JOptionPane.showInternalMessageDialog(this,"El número de Resolución no existe","Aviso",JOptionPane.INFORMATION_MESSAGE);
                return false;
            }else{
                return true;
            }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("Reportes de Resoluciones");
        setFrameIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/Mazo.jpg"))); // NOI18N

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/repoResoluciones.jpg"))); // NOI18N
        ...
        rbtnPromocion.setText("Información de Resolución");
        ...
        rbtnListado.setText("Listado de Resoluciones por Año");
