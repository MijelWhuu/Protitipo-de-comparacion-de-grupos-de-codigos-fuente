...
import bl.reportes.ListadoReportesBl;
 ...
 * @author mavg
 */
public class ListadoReportes extends javax.swing.JInternalFrame {

    SesionEntity sesion;
    ListadoReportesBl bl = new ListadoReportesBl();
    ...
    String [] jasper = {
        "-1",
        "actosGrafica.jasper",
        "promocionGrafica.jasper",
        "autosMesasGrafica.jasper",
        "autosSecreGrafica.jasper",
        "resolucionesGrafica.jasper",
        "sentenciasGrafica.jasper"
    };
    ...
    public ListadoReportes(SesionEntity sesion) {
        this.sesion = sesion;
        initComponents();
        mapeoTeclas();
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("Reportes Estadísticos");
        setFrameIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/Mazo.jpg"))); // NOI18N

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/repor_esta.jpg"))); // NOI18N
        ...
        cmbCatalogo.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Elija una opción", "Actos Impugnados", "Promociones", "Autos de Mesas de Trámite", "Autos de Secretaría de Acuerdos", "Resoluciones", "Sentencias-Resoluciones" }));
        ...
        jLabel2.setBounds(10, 110, 40, 30);
        ...
        txtAnio.setBounds(50, 110, 70, 30);
