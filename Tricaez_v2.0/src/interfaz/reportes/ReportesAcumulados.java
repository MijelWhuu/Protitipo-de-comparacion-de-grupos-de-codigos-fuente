...
import bl.reportes.ReportesAcumuladosBl;
 ...
 * @author mavg
 */
public class ReportesAcumulados extends javax.swing.JInternalFrame {

    SesionEntity sesion;
    ReportesAcumuladosBl bl = new ReportesAcumuladosBl();
    Utilidades u = new Utilidades();
    String jasper1 = "acumuladoExpediente.jasper";
    Calendar cal = Calendar.getInstance(TimeZone.getDefault());
    
    /**
     * Creates new form ArchivarExpedientes
     */
    public ReportesAcumulados() {
        initComponents();
    }

    public ReportesAcumulados(SesionEntity sesion) {
        this.sesion = sesion;
        initComponents();
        mapeoTeclas();
    }
    ...
    private void botonF2(){
        bl.reporteVisualizarSimple(jasper1);
    }
    ...
    private void botonF4(){
        try{
            ...
            if(!dir.equals("")){
                if(bl.reporteToPDFSimple(jasper1,dir)){
    ...
    private void botonF6(){
        bl.reporteImprimirSimple(jasper1);
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("Reporte de Expedientes Acumulados");
        setFrameIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/Mazo.jpg"))); // NOI18N

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/repor_Acumulado.jpg"))); // NOI18N
        ...
        rbtnPromocion.setText("Expedientes Acumulados");
