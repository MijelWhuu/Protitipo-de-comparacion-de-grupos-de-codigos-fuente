...
import bl.reportes.ReportesAutosBl;
 ...
 * @author mavg
 */
public class ReportesAutos extends javax.swing.JInternalFrame {

    SesionEntity sesion;
    ReportesAutosBl bl = new ReportesAutosBl();
    RegistroAutosBl blNew = new RegistroAutosBl();
    Utilidades u = new Utilidades();
    String jasper1 = "autoSimple.jasper";
    String jasper2 = "autoGrupo.jasper";
    Calendar cal = Calendar.getInstance(TimeZone.getDefault());
    
    /**
     * Creates new form ArchivarExpedientes
     */
    public ReportesAutos() {
        initComponents();
    }

    public ReportesAutos(SesionEntity sesion) {
        this.sesion = sesion;
        initComponents();
        mapeoTeclas();
        seleccion();
    ...
    private Boolean valida(){
        if(rbtnPromocion.isSelected()){
            if(txtFolio.getText().length()==0){
                ...
                txtFolio.requestFocus();
                return false;
            }else if(!blNew.existeFolio(new Integer(txtFolio.getText()), getAnio())){
                JOptionPane.showInternalMessageDialog(this,"El número de Auto no existe","Aviso",JOptionPane.INFORMATION_MESSAGE);
                return false;
            }else{
                return true;
            }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("Reportes de Autos");
        setFrameIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/Mazo.jpg"))); // NOI18N

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/repoAutos.jpg"))); // NOI18N
        ...
        rbtnPromocion.setText("Información del Auto");
        ...
        rbtnListado.setText("Listado de Autos por Año");
