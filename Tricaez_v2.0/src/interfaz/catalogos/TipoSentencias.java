 ...
 * @author mavg
 */
public class TipoSentencias extends javax.swing.JInternalFrame {

    SesionEntity sesion;
    TipoSentenciasBl bl = new TipoSentenciasBl();
    Utilidades u = new Utilidades();
    
    /**
     * Creates new form Destinos
     */
    public TipoSentencias(){
        initComponents();
    }
    
    public TipoSentencias(SesionEntity sesion) {
        this.sesion = sesion;
        initComponents();
        formatosCampos();
        mapeoTeclas();
    ...
    private void inicializaCombo(){
        u.inicializaCombo(cmbDestino, new TipoSentenciaEntity(), bl.getTipoSentencias());
    }
    ...
    private void botonF2(){
        if(jTabbedPane1.getSelectedIndex()==0){
            if(txtNombreNew.getText().length()==0){
                ...
                ErrorEntity error = bl.saveTipoSentencia(new TipoSentenciaEntity(txtNombreNew.getText(), txtObservacionesNew.getText(), cbxDefaultNew.isSelected()),sesion);
                if(!error.getError()){
    ...
    private void botonF4(){
        if(jTabbedPane1.getSelectedIndex()==1 && cmbDestino.getItemCount()>1){
            if(cmbDestino.getSelectedIndex()==0){
                ...
                TipoSentenciaEntity tipo = (TipoSentenciaEntity)cmbDestino.getSelectedItem();
                ...
                ErrorEntity error = bl.updateTipoSentencia(tipo, sesion);
                if(!error.getError()){
        ...
        if(jTabbedPane1.getSelectedIndex()==1 && cmbDestino.getItemCount()>1){
            if(cmbDestino.getSelectedIndex()==0){
                ...
                if(javax.swing.JOptionPane.showInternalConfirmDialog(this, "¿Desea eliminar el elemento seleccionado?", "Alerta", 0)==0){
                    ErrorEntity error = bl.deleteTipoSentencia(((TipoSentenciaEntity)cmbDestino.getSelectedItem()).getId_tipo_sentencia());
                    if(!error.getError()){
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("Catálogo - Tipo de Sentencias");
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/Cat_tipo_sentencias.jpg"))); // NOI18N
        ...
        jLabel7.setText("Nombre del Tipo de Sentencia");
        jPanel1.add(jLabel7);
        ...
        jScrollPane3.setBounds(10, 190, 620, 70);
        ...
        jLabel4.setText("Tipo de Sentencias");
        ...
        jLabel5.setText("Nombre del Tipo de Sentencia");
        jPanel2.add(jLabel5);
        jLabel5.setBounds(20, 110, 220, 30);
        ...
        txtObservacionesUpdate.setRows(3);
        ...
        jScrollPane2.setBounds(10, 240, 620, 70);
        ...
        cbxDefaultUpdate.setBounds(10, 180, 260, 25);
