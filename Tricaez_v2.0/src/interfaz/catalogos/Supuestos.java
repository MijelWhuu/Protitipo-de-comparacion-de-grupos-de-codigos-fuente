...
import bl.catalogos.SupuestosBl;
 ...
 * @author mavg
 */
public class Supuestos extends javax.swing.JInternalFrame {

    SesionEntity sesion;
    SupuestosBl bl = new SupuestosBl();
    ...
    public Supuestos(SesionEntity sesion) {
        this.sesion = sesion;
        initComponents();
        formatosCampos();
        mapeoTeclas();
    ...
    private void inicializaCombo(){
        u.inicializaCombo(cmbDestino, new SupuestoEntity(), bl.getSupuestos());
    }
    ...
    private void botonF2(){
        if(jTabbedPane1.getSelectedIndex()==0){
            if(txtNombreNew.getText().length()==0){
                ...
                ErrorEntity error = bl.saveSupuesto(new SupuestoEntity(txtNombreNew.getText(), txtObservacionesNew.getText(),cbxDefaultNew.isSelected()),sesion);
                if(!error.getError()){
    ...
    private void botonF4(){
        if(jTabbedPane1.getSelectedIndex()==1 && cmbDestino.getItemCount()>1){
            if(cmbDestino.getSelectedIndex()==0){
                ...
                SupuestoEntity tipo = (SupuestoEntity)cmbDestino.getSelectedItem();
                ...
                ErrorEntity error = bl.updateSupuesto(tipo, sesion);
                if(!error.getError()){
        ...
        if(jTabbedPane1.getSelectedIndex()==1 && cmbDestino.getItemCount()>1){
            if(cmbDestino.getSelectedIndex()==0){
                ...
                if(javax.swing.JOptionPane.showInternalConfirmDialog(this, "¿Desea eliminar el elemento seleccionado?", "Alerta", 0)==0){
                    ErrorEntity error = bl.deleteSupuesto(((SupuestoEntity)cmbDestino.getSelectedItem()).getId_supuesto());
                    if(!error.getError()){
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/Cat_supuestos.jpg"))); // NOI18N
        ...
        jScrollPane3.setBounds(10, 200, 480, 86);
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addComponent(cmbDestino, 0, 371, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        jScrollPane2.setBounds(10, 240, 480, 86);
        ...
        cbxDefaultUpdate.setBounds(10, 170, 260, 30);
