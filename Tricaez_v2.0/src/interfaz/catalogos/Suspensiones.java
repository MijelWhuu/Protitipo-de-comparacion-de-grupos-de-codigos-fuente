 ...
 * @author mavg
 */
public class Suspensiones extends javax.swing.JInternalFrame {

    SesionEntity sesion;
    SuspensionesBl bl = new SuspensionesBl();
    ...
    public Suspensiones(SesionEntity sesion) {
        this.sesion = sesion;
        initComponents();
        formatosCampos();
        mapeoTeclas();
    ...
    private void inicializaCombo(){
        u.inicializaCombo(cmbDestino, new SuspensionEntity(), bl.getSuspensiones());
    }
    ...
    private void botonF2(){
        if(jTabbedPane1.getSelectedIndex()==0){
            if(txtNombreNew.getText().length()==0){
                ...
                ErrorEntity error = bl.saveSuspension(new SuspensionEntity(txtNombreNew.getText(),txtObservacionesNew.getText(),cbxDefaultNew.isSelected()), sesion);
                if(!error.getError()){
    ...
    private void botonF4(){
        if(jTabbedPane1.getSelectedIndex()==1 && cmbDestino.getItemCount()>1){
            if(cmbDestino.getSelectedIndex()==0){
                ...
                SuspensionEntity tipo = (SuspensionEntity)cmbDestino.getSelectedItem();
                ...
                ErrorEntity error = bl.updateSuspension(tipo, sesion);
                if(!error.getError()){
        ...
        if(jTabbedPane1.getSelectedIndex()==1 && cmbDestino.getItemCount()>1){
            if(cmbDestino.getSelectedIndex()==0){
                ...
                if(javax.swing.JOptionPane.showInternalConfirmDialog(this, "¿Desea eliminar el elemento seleccionado?", "Alerta", 0)==0){
                    ErrorEntity error = bl.deleteSuspension(((SuspensionEntity)cmbDestino.getSelectedItem()).getId_suspension());
                    if(!error.getError()){
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("Catálogo - Suspensiones");
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/Cat_suspensiones.jpg"))); // NOI18N
        ...
        jScrollPane3.setBounds(10, 190, 500, 86);
        ...
        jLabel4.setText("Suspensión");
        jPanel3.add(jLabel4);
        jLabel4.setBounds(16, 29, 90, 30);
        ...
        cmbDestino.setBounds(104, 29, 380, 30);

        jPanel2.add(jPanel3);
        jPanel3.setBounds(10, 11, 500, 80);

        jLabel5.setFont(new java.awt.Font("Tahoma", 1, 13)); // NOI18N
        jLabel5.setText("Nombre de la Suspensión");
        jPanel2.add(jLabel5);
        jLabel5.setBounds(20, 90, 200, 30);

        txtNombreUpdate.setFont(new java.awt.Font("Tahoma", 0, 13)); // NOI18N
        jPanel2.add(txtNombreUpdate);
        txtNombreUpdate.setBounds(10, 120, 500, 30);
        ...
        jScrollPane2.setBounds(10, 240, 500, 80);
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addContainerGap())
            .addComponent(jLabel1, javax.swing.GroupLayout.PREFERRED_SIZE, 686, Short.MAX_VALUE)
        );
