...
public class Autos extends javax.swing.JInternalFrame {
    ...
    public Autos(SesionEntity sesion) {
        this.sesion = sesion;
        initComponents();
        formatosCampos();
        mapeoTeclas();
    ...
    private void inicializaCombo(){
        u.inicializaCombo(cmbDestino, new AutoEntity(), bl.getAutos());
    }
    ...
    private void botonF2(){
        if(jTabbedPane1.getSelectedIndex()==0){
            if(txtNombreNew.getText().length()==0){
                ...
                ErrorEntity error = bl.saveAuto(new AutoEntity(txtNombreNew.getText(),txtObservacionesNew.getText(),cbxDefaultNew.isSelected(),rbtnMesaNew.isSelected()), sesion);
                if(!error.getError()){
    ...
    private void botonF4(){
        if(jTabbedPane1.getSelectedIndex()==1 && cmbDestino.getItemCount()>1){
            if(cmbDestino.getSelectedIndex()==0){
                ...
                AutoEntity fil = (AutoEntity)cmbDestino.getSelectedItem();
                fil.setNombre(txtNombreUpdate.getText());
                fil.setObservaciones(txtObservacionesUpdate.getText());
                fil.setSeleccionar(cbxDefaultUpdate.isSelected());
                fil.setTipo(rbtnMesaUpdate.isSelected());
                ErrorEntity error = bl.updateFiltro(fil, sesion);
                if(!error.getError()){
        ...
        if(jTabbedPane1.getSelectedIndex()==1 && cmbDestino.getItemCount()>1){
            if(cmbDestino.getSelectedIndex()==0){
                ...
                if(javax.swing.JOptionPane.showInternalConfirmDialog(this, "¿Desea eliminar el elemento seleccionado?", "Alerta", 0)==0){
                    ErrorEntity error = bl.deleteFiltro(((AutoEntity)cmbDestino.getSelectedItem()).getId_tipo_auto());
                    if(!error.getError()){
    ...
    private void initComponents() {
        ...
        rbtnMesaNew = new javax.swing.JRadioButton();
        rbtnSecreNew = new javax.swing.JRadioButton();
        ...
        rbtnMesaUpdate = new javax.swing.JRadioButton();
        rbtnSecreUpdate = new javax.swing.JRadioButton();
        ...
        setClosable(true);
        setTitle("Catálogo - Tipo de Autos");
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/Cat_autos.jpg"))); // NOI18N
        ...
        jLabel7.setText("Nombre del Auto");
        jPanel1.add(jLabel7);
        jLabel7.setBounds(20, 40, 210, 30);

        txtNombreNew.setFont(new java.awt.Font("Tahoma", 0, 13)); // NOI18N
        jPanel1.add(txtNombreNew);
        txtNombreNew.setBounds(10, 70, 750, 30);

        jLabel8.setFont(new java.awt.Font("Tahoma", 1, 13)); // NOI18N
        jLabel8.setText("Observaciones");
        jPanel1.add(jLabel8);
        jLabel8.setBounds(10, 260, 134, 30);
        ...
        txtObservacionesNew.setRows(2);
        txtObservacionesNew.setWrapStyleWord(true);
        ...
        jScrollPane3.setBounds(10, 290, 750, 70);
        ...
        cbxDefaultNew.setBounds(10, 220, 260, 25);

        jPanel5.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Tipo de Auto", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 13))); // NOI18N

        buttonGroup2.add(rbtnMesaNew);
        rbtnMesaNew.setFont(new java.awt.Font("Tahoma", 1, 13)); // NOI18N
        rbtnMesaNew.setSelected(true);
        rbtnMesaNew.setText("Mesas de Trámite");

        buttonGroup2.add(rbtnSecreNew);
        rbtnSecreNew.setFont(new java.awt.Font("Tahoma", 1, 13)); // NOI18N
        rbtnSecreNew.setText("Secretaría de Acuerdos");
        ...
        jPanel5Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(rbtnMesaNew, javax.swing.GroupLayout.PREFERRED_SIZE, 157, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addComponent(rbtnSecreNew, javax.swing.GroupLayout.PREFERRED_SIZE, 208, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel5Layout.setVerticalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(rbtnMesaNew)
                    .addComponent(rbtnSecreNew))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );

        jPanel1.add(jPanel5);
        jPanel5.setBounds(10, 130, 750, 60);
        ...
        cmbDestino.setBounds(20, 40, 710, 30);

        jPanel2.add(jPanel3);
        jPanel3.setBounds(10, 10, 750, 100);

        jLabel5.setFont(new java.awt.Font("Tahoma", 1, 13)); // NOI18N
        jLabel5.setText("Nombre del Auto");
        jPanel2.add(jLabel5);
        jLabel5.setBounds(20, 110, 140, 30);

        txtNombreUpdate.setFont(new java.awt.Font("Tahoma", 0, 13)); // NOI18N
        jPanel2.add(txtNombreUpdate);
        txtNombreUpdate.setBounds(10, 140, 750, 30);

        jLabel6.setFont(new java.awt.Font("Tahoma", 1, 13)); // NOI18N
        jLabel6.setText("Observaciones");
        jPanel2.add(jLabel6);
        jLabel6.setBounds(10, 280, 134, 30);

        txtObservacionesUpdate.setColumns(20);
        txtObservacionesUpdate.setFont(new java.awt.Font("Tahoma", 0, 13)); // NOI18N
        txtObservacionesUpdate.setLineWrap(true);
        txtObservacionesUpdate.setRows(2);
        txtObservacionesUpdate.setWrapStyleWord(true);
        ...
        jScrollPane2.setBounds(10, 310, 750, 60);
        ...
        cbxDefaultUpdate.setBounds(10, 250, 260, 25);

        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Tipo de Auto", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 13))); // NOI18N

        buttonGroup1.add(rbtnMesaUpdate);
        rbtnMesaUpdate.setFont(new java.awt.Font("Tahoma", 1, 13)); // NOI18N
        rbtnMesaUpdate.setText("Mesas de Trámite");

        buttonGroup1.add(rbtnSecreUpdate);
        rbtnSecreUpdate.setFont(new java.awt.Font("Tahoma", 1, 13)); // NOI18N
        rbtnSecreUpdate.setText("Secretaría de Acuerdos");
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(rbtnMesaUpdate, javax.swing.GroupLayout.PREFERRED_SIZE, 157, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addComponent(rbtnSecreUpdate, javax.swing.GroupLayout.PREFERRED_SIZE, 208, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(349, Short.MAX_VALUE))
        );
        jPanel4Layout.setVerticalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(rbtnMesaUpdate)
                    .addComponent(rbtnSecreUpdate))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );

        jPanel2.add(jPanel4);
        jPanel4.setBounds(10, 180, 750, 60);
    ...
    private void cmbDestinoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmbDestinoActionPerformed
        if(cmbDestino.getItemCount()>0){
            ...
            if(cmbDestino.getSelectedIndex()==0){
                ...
                rbtnMesaUpdate.setEnabled(false);
                rbtnSecreUpdate.setEnabled(false);
                rbtnMesaUpdate.setSelected(false);
            }else{
                txtNombreUpdate.setEnabled(true);
                cbxDefaultUpdate.setSelected(true);
                cbxDefaultUpdate.setEnabled(true);
                txtObservacionesUpdate.setEnabled(true);
                rbtnMesaUpdate.setEnabled(true);
                rbtnSecreUpdate.setEnabled(true);
                rbtnMesaUpdate.setSelected(true);
                AutoEntity tipo = (AutoEntity)cmbDestino.getSelectedItem();
                txtNombreUpdate.setText(tipo.getNombre());
                rbtnMesaUpdate.setSelected(tipo.getTipo());
    ...
    private javax.swing.JRadioButton rbtnMesaNew;
    private javax.swing.JRadioButton rbtnMesaUpdate;
    private javax.swing.JRadioButton rbtnSecreNew;
    private javax.swing.JRadioButton rbtnSecreUpdate;
