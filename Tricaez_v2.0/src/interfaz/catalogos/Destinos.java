...
public class Destinos extends javax.swing.JInternalFrame {
    ...
    public Destinos(SesionEntity sesion) {
        this.sesion = sesion;
        initComponents();
        formatosCampos();
        mapeoTeclas();
    ...
    private void inicializaCombo(){
        u.inicializaCombo(cmbDestino, new DestinoEntity(), bl.getDestinos());
    }
    ...
    private void botonF2(){
        if(jTabbedPane1.getSelectedIndex()==0){
            if(txtNombreNew.getText().length()==0){
                ...
                ErrorEntity error = bl.saveDestino(new DestinoEntity(txtNombreNew.getText(), txtObservacionesNew.getText(),cbxDefaultNew.isSelected()),sesion);
                if(!error.getError()){
    ...
    private void botonF4(){
        if(jTabbedPane1.getSelectedIndex()==1 && cmbDestino.getItemCount()>1){
            if(cmbDestino.getSelectedIndex()==0){
                ...
                DestinoEntity tipo = (DestinoEntity)cmbDestino.getSelectedItem();
                ...
                ErrorEntity error = bl.updateDestino(tipo,sesion);
                if(!error.getError()){
        ...
        if(jTabbedPane1.getSelectedIndex()==1 && cmbDestino.getItemCount()>1){
            if(cmbDestino.getSelectedIndex()==0){
                ...
                if(javax.swing.JOptionPane.showInternalConfirmDialog(this, "¿Desea eliminar el elemento seleccionado?", "Alerta", 0)==0){
                    ErrorEntity error = bl.deleteDestino(((DestinoEntity)cmbDestino.getSelectedItem()).getId_destino());
                    if(!error.getError()){
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/Cat_destinos.jpg"))); // NOI18N
        ...
        jLabel7.setText("Nombre del Destino");
        jPanel1.add(jLabel7);
        ...
        cmbDestino.setBounds(80, 30, 350, 30);
