 ...
 * @author mavg
 */
public class Actos extends javax.swing.JInternalFrame {

    SesionEntity sesion;
    ActosBl bl = new ActosBl();
    ...
    public Actos(SesionEntity sesion) {
        this.sesion = sesion;
        initComponents();
        formatosCampos();
        mapeoTeclas();
    ...
    private void inicializaCombo(){
        u.inicializaCombo(cmbDestino, new ActoEntity(), bl.getActos());
    }
    ...
    private void botonF2(){
        if(jTabbedPane1.getSelectedIndex()==0){
            if(txtNombreNew.getText().length()==0){
                ...
                ErrorEntity error = bl.saveActo(new ActoEntity(txtNombreNew.getText(), txtObservacionesNew.getText(),cbxDefaultNew.isSelected()),sesion);
                if(!error.getError()){
    ...
    private void botonF4(){
        if(jTabbedPane1.getSelectedIndex()==1 && cmbDestino.getItemCount()>1){
            if(cmbDestino.getSelectedIndex()==0){
                ...
                ActoEntity tipo = (ActoEntity)cmbDestino.getSelectedItem();
                ...
                ErrorEntity error = bl.updateActo(tipo,sesion);
                if(!error.getError()){
        ...
        if(jTabbedPane1.getSelectedIndex()==1 && cmbDestino.getItemCount()>1){
            if(cmbDestino.getSelectedIndex()==0){
                ...
                if(javax.swing.JOptionPane.showInternalConfirmDialog(this, "¿Desea eliminar el elemento seleccionado?", "Alerta", 0)==0){
                    ErrorEntity error = bl.deleteActo(((ActoEntity)cmbDestino.getSelectedItem()).getId_acto());
                    if(!error.getError()){
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("Catálogo - Actos Impugnados");
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/Cat_actos_impugnados.jpg"))); // NOI18N
        ...
        jScrollPane3.setBounds(10, 190, 560, 80);
        ...
        jLabel4.setText("Actos");
        jPanel3.add(jLabel4);
        jLabel4.setBounds(16, 30, 50, 30);
        ...
        cmbDestino.setBounds(70, 30, 480, 30);

        jPanel2.add(jPanel3);
        jPanel3.setBounds(10, 10, 560, 80);

        jLabel5.setFont(new java.awt.Font("Tahoma", 1, 13)); // NOI18N
        jLabel5.setText("Nombre del Acto Impugnado");
        jPanel2.add(jLabel5);
        jLabel5.setBounds(20, 90, 430, 30);

        txtNombreUpdate.setFont(new java.awt.Font("Tahoma", 0, 13)); // NOI18N
        jPanel2.add(txtNombreUpdate);
        txtNombreUpdate.setBounds(10, 120, 560, 30);
        ...
        jScrollPane2.setBounds(10, 240, 560, 80);
