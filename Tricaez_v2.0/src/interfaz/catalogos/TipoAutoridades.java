 ...
 * @author mavg
 */
public class TipoAutoridades extends javax.swing.JInternalFrame {

    SesionEntity sesion;
    TipoAutoridadesBl bl = new TipoAutoridadesBl();
    Utilidades u = new Utilidades();
    
    /**
     * Creates new form Destinos
     */
    public TipoAutoridades(){
        initComponents();
    }
    
    public TipoAutoridades(SesionEntity sesion) {
        this.sesion = sesion;
        initComponents();
        formatosCampos();
        mapeoTeclas();
    ...
    private void inicializaCombo(){
        u.inicializaCombo(cmbDestino, new TipoAutoridadEntity(), bl.getTipoAutoridades());
    }
    ...
    private void botonF2(){
        if(jTabbedPane1.getSelectedIndex()==0){
            if(txtNombreNew.getText().length()==0){
                ...
                TipoAutoridadEntity tipo = new TipoAutoridadEntity(txtNombreNew.getText(), cbxReglaNew.isSelected(), txtObservacionesNew.getText());
                ErrorEntity error = bl.saveTipoAutoridad(tipo, sesion);
                if(!error.getError()){
    ...
    private void botonF4(){
        if(jTabbedPane1.getSelectedIndex()==1 && cmbDestino.getItemCount()>1){
            if(cmbDestino.getSelectedIndex()==0){
                ...
                TipoAutoridadEntity tipo = (TipoAutoridadEntity)cmbDestino.getSelectedItem();
                tipo.setNombre(txtNombreUpdate.getText());
                tipo.setRegla(cbxReglaUpdate.isSelected());
                tipo.setObservaciones(txtObservacionesUpdate.getText());
                ErrorEntity error = bl.updateTipoAutoridad(tipo, sesion);
                if(!error.getError()){
        ...
        if(jTabbedPane1.getSelectedIndex()==1 && cmbDestino.getItemCount()>1){
            if(cmbDestino.getSelectedIndex()==0){
                ...
                if(javax.swing.JOptionPane.showInternalConfirmDialog(this, "¿Desea eliminar el elemento seleccionado?", "Alerta", 0)==0){
                    ErrorEntity error = bl.deleteTipoAutoridad(((TipoAutoridadEntity)cmbDestino.getSelectedItem()).getId_tipo_autoridad());
                    if(!error.getError()){
    ...
    private void initComponents() {
        ...
        cbxReglaNew = new javax.swing.JCheckBox();
        ...
        cbxReglaUpdate = new javax.swing.JCheckBox();
        ...
        setClosable(true);
        setTitle("Catálogo - Tipo de Autoridades");
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/Cat_tipo_autoridades.jpg"))); // NOI18N
        ...
        jScrollPane3.setBounds(10, 140, 510, 80);
        ...
        cbxReglaNew.setFont(new java.awt.Font("Tahoma", 1, 13)); // NOI18N
        cbxReglaNew.setText("Aplicar Regla Municipal");
        jPanel1.add(cbxReglaNew);
        cbxReglaNew.setBounds(340, 70, 180, 30);
        ...
        jPanel3.add(jLabel4);
        jLabel4.setBounds(16, 30, 150, 30);
        ...
        cmbDestino.setBounds(170, 30, 330, 30);

        jPanel2.add(jPanel3);
        jPanel3.setBounds(10, 11, 510, 80);

        jLabel5.setFont(new java.awt.Font("Tahoma", 1, 13)); // NOI18N
        jLabel5.setText("Nombre del Tipo de Autoridad");
        jPanel2.add(jLabel5);
        jLabel5.setBounds(20, 90, 490, 30);

        txtNombreUpdate.setFont(new java.awt.Font("Tahoma", 0, 13)); // NOI18N
        jPanel2.add(txtNombreUpdate);
        txtNombreUpdate.setBounds(10, 120, 320, 30);

        jLabel6.setFont(new java.awt.Font("Tahoma", 1, 13)); // NOI18N
        jLabel6.setText("Observaciones");
        jPanel2.add(jLabel6);
        jLabel6.setBounds(10, 160, 134, 30);
        ...
        jScrollPane2.setBounds(10, 190, 510, 80);
        ...
        cbxReglaUpdate.setFont(new java.awt.Font("Tahoma", 1, 13)); // NOI18N
        cbxReglaUpdate.setText("Aplicar Regla Municipal");
        jPanel2.add(cbxReglaUpdate);
        cbxReglaUpdate.setBounds(340, 120, 180, 30);
    ...
    private void cmbDestinoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmbDestinoActionPerformed
        if(cmbDestino.getItemCount()>0){
            ...
            if(cmbDestino.getSelectedIndex()==0){
                u.enabledComponet(false, txtNombreUpdate,txtObservacionesUpdate,cbxReglaUpdate);
                cbxReglaUpdate.setSelected(false);
            }else{
                u.enabledComponet(true, txtNombreUpdate,txtObservacionesUpdate,cbxReglaUpdate);
                cbxReglaUpdate.setSelected(false);
                TipoAutoridadEntity tipo = (TipoAutoridadEntity)cmbDestino.getSelectedItem();
                txtNombreUpdate.setText(tipo.getNombre());
                cbxReglaUpdate.setSelected(tipo.getRegla());
    ...
    private javax.swing.JCheckBox cbxReglaNew;
    private javax.swing.JCheckBox cbxReglaUpdate;
