 ...
 * @author mavg
 */
public class Procedimientos extends javax.swing.JInternalFrame {

    SesionEntity sesion;
    ProcedimientosBl bl = new ProcedimientosBl();
    ...
    public Procedimientos(SesionEntity sesion) {
        this.sesion = sesion;
        initComponents();
        formatosCampos();
        mapeoTeclas();
    ...
    private void inicializaCombo(){
        u.inicializaCombo(cmbDestino, new ProcedimientoEntity(), bl.getProcedimientos());
    }
    ...
    private void botonF2(){
        if(jTabbedPane1.getSelectedIndex()==0){
            if(txtNombreNew.getText().length()==0){
                ...
                ErrorEntity error = bl.saveProcedimiento(new ProcedimientoEntity(txtNombreNew.getText(),txtObservacionesNew.getText(),cbxDefaultNew.isSelected()),sesion);
                if(!error.getError()){
    ...
    private void botonF4(){
        if(jTabbedPane1.getSelectedIndex()==1 && cmbDestino.getItemCount()>1){
            if(cmbDestino.getSelectedIndex()==0){
                ...
                ProcedimientoEntity tipo = (ProcedimientoEntity)cmbDestino.getSelectedItem();
                ...
                ErrorEntity error = bl.updateProcedimiento(tipo, sesion);
                if(!error.getError()){
        ...
        if(jTabbedPane1.getSelectedIndex()==1 && cmbDestino.getItemCount()>1){
            if(cmbDestino.getSelectedIndex()==0){
                ...
                if(javax.swing.JOptionPane.showInternalConfirmDialog(this, "¿Desea eliminar el elemento seleccionado?", "Alerta", 0)==0){
                    ErrorEntity error = bl.deleteProcedimiento(((ProcedimientoEntity)cmbDestino.getSelectedItem()).getId_procedimientos());
                    if(!error.getError()){
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("Catálogo - Procedimientos");
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/Cat_procedimientos.jpg"))); // NOI18N
        ...
        jLabel7.setText("Nombre del Procedimiento");
        jPanel1.add(jLabel7);
        jLabel7.setBounds(20, 40, 220, 30);

        txtNombreNew.setFont(new java.awt.Font("Tahoma", 0, 13)); // NOI18N
        jPanel1.add(txtNombreNew);
        txtNombreNew.setBounds(10, 70, 440, 30);
        ...
        jPanel3.add(jLabel4);
        jLabel4.setBounds(16, 30, 110, 30);
        ...
        jScrollPane2.setBounds(10, 220, 440, 90);
        ...
        cbxDefaultUpdate.setBounds(10, 160, 260, 25);
