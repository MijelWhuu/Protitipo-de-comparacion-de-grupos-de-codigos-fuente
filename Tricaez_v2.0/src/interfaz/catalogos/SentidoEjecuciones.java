 ...
 * @author mavg
 */
public class SentidoEjecuciones extends javax.swing.JInternalFrame {

    SesionEntity sesion;
    SentidoEjecucionesBl bl = new SentidoEjecucionesBl();
    Utilidades u = new Utilidades();
    
    /**
     * Creates new form Destinos
     */
    public SentidoEjecuciones(){
        initComponents();
    }
    
    public SentidoEjecuciones(SesionEntity sesion) {
        this.sesion = sesion;
        initComponents();
        formatosCampos();
        mapeoTeclas();
    ...
    private void inicializaCombo(){
        u.inicializaCombo(cmbDestino, new SentidoEjecutoriaEntity(), bl.getSentidoEjecuciones());
    }
    ...
    private void botonF2(){
        if(jTabbedPane1.getSelectedIndex()==0){
            if(txtNombreNew.getText().length()==0){
                ...
                ErrorEntity error = bl.saveSentidoEjecucion(new SentidoEjecutoriaEntity(txtNombreNew.getText(), txtObservacionesNew.getText(),cbxDefaultNew.isSelected()),sesion);
                if(!error.getError()){
    ...
    private void botonF4(){
        if(jTabbedPane1.getSelectedIndex()==1 && cmbDestino.getItemCount()>1){
            if(cmbDestino.getSelectedIndex()==0){
                ...
                SentidoEjecutoriaEntity tipo = (SentidoEjecutoriaEntity)cmbDestino.getSelectedItem();
                ...
                ErrorEntity error = bl.updateSentidoEjecucion(tipo, sesion);
                if(!error.getError()){
        ...
        if(jTabbedPane1.getSelectedIndex()==1 && cmbDestino.getItemCount()>1){
            if(cmbDestino.getSelectedIndex()==0){
                ...
                if(javax.swing.JOptionPane.showInternalConfirmDialog(this, "¿Desea eliminar el elemento seleccionado?", "Alerta", 0)==0){
                    ErrorEntity error = bl.deleteSentidoEjecucion(((SentidoEjecutoriaEntity)cmbDestino.getSelectedItem()).getId_sentido_ejecutoria());
                    if(!error.getError()){
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("Catálogo - Sentidos de Ejecutoria");
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/Cat_sentidos_ejecutoria.jpg"))); // NOI18N
        ...
        jLabel7.setText("Nombre del Sentido de Ejecutoria");
        jPanel1.add(jLabel7);
        jLabel7.setBounds(20, 50, 250, 30);

        txtNombreNew.setFont(new java.awt.Font("Tahoma", 0, 13)); // NOI18N
        jPanel1.add(txtNombreNew);
        txtNombreNew.setBounds(10, 80, 510, 30);
        ...
        jScrollPane3.setBounds(10, 200, 510, 86);

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 13)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 0, 0));
        jLabel2.setText("*");
        jPanel1.add(jLabel2);
        jLabel2.setBounds(10, 50, 20, 30);
        ...
        cbxDefaultNew.setBounds(10, 130, 260, 25);
        ...
        jLabel4.setText("Sentidos de Ejecutoria");
        jPanel3.add(jLabel4);
        ...
        cmbDestino.setBounds(10, 60, 490, 30);

        jPanel2.add(jPanel3);
        jPanel3.setBounds(10, 11, 510, 110);

        jLabel5.setFont(new java.awt.Font("Tahoma", 1, 13)); // NOI18N
        jLabel5.setText("Nombre del Sentido de Ejecutoria");
        jPanel2.add(jLabel5);
        jLabel5.setBounds(20, 120, 250, 30);

        txtNombreUpdate.setFont(new java.awt.Font("Tahoma", 0, 13)); // NOI18N
        jPanel2.add(txtNombreUpdate);
        txtNombreUpdate.setBounds(10, 150, 510, 30);
        ...
        txtObservacionesUpdate.setRows(5);
        ...
        jScrollPane2.setBounds(10, 260, 510, 86);

        jLabel3.setFont(new java.awt.Font("Tahoma", 1, 13)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 0, 0));
        jLabel3.setText("*");
        jPanel2.add(jLabel3);
        jLabel3.setBounds(10, 120, 30, 30);
        ...
        cbxDefaultUpdate.setBounds(10, 200, 260, 25);
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(btnF2, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(btnF4, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(btnF6, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(btnF12, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(btnEsc, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE))
