 ...
 * @author mavg
 */
public class TipoNotificaciones extends javax.swing.JInternalFrame {

    SesionEntity sesion;
    TipoNotificacionesBl bl = new TipoNotificacionesBl();
    ...
    public TipoNotificaciones(SesionEntity sesion) {
        this.sesion = sesion;
        initComponents();
        formatosCampos();
        mapeoTeclas();
    ...
    private void inicializaCombo(){
        u.inicializaCombo(cmbDestino, new TipoNotificacionEntity(), bl.getTipoNotificaciones());
    }
    ...
    private void botonF2(){
        if(jTabbedPane1.getSelectedIndex()==0){
            if(txtNombreNew.getText().length()==0){
                ...
                ErrorEntity error = bl.saveTipoNotificacion(new TipoNotificacionEntity(txtNombreNew.getText(), txtObservacionesNew.getText(),cbxDefaultNew.isSelected()), sesion);
                if(!error.getError()){
    ...
    private void botonF4(){
        if(jTabbedPane1.getSelectedIndex()==1 && cmbDestino.getItemCount()>1){
            if(cmbDestino.getSelectedIndex()==0){
                ...
                TipoNotificacionEntity tipo = (TipoNotificacionEntity)cmbDestino.getSelectedItem();
                ...
                ErrorEntity error = bl.updateTipoNotificacion(tipo, sesion);
                if(!error.getError()){
        ...
        if(jTabbedPane1.getSelectedIndex()==1 && cmbDestino.getItemCount()>1){
            if(cmbDestino.getSelectedIndex()==0){
                ...
                if(javax.swing.JOptionPane.showInternalConfirmDialog(this, "¿Desea eliminar el elemento seleccionado?", "Alerta", 0)==0){
                    ErrorEntity error = bl.deleteTipoNotificacion(((TipoNotificacionEntity)cmbDestino.getSelectedItem()).getId_tipo_notificacion());
                    if(!error.getError()){
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("Catálogo - Tipo de Notificaciones");
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/Cat_tipo_notificaciones.jpg"))); // NOI18N
        ...
        jLabel7.setText("Nombre del Tipo de Notificación");
        jPanel1.add(jLabel7);
        jLabel7.setBounds(20, 50, 220, 30);

        txtNombreNew.setFont(new java.awt.Font("Tahoma", 0, 13)); // NOI18N
        jPanel1.add(txtNombreNew);
        txtNombreNew.setBounds(10, 80, 390, 30);
        ...
        jScrollPane3.setBounds(10, 200, 390, 86);
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Búsqueda", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 14))); // NOI18N

        jLabel4.setFont(new java.awt.Font("Tahoma", 1, 13)); // NOI18N
        jLabel4.setText("Tipo de Notificaciones");
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addComponent(cmbDestino, javax.swing.GroupLayout.PREFERRED_SIZE, 220, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel2.add(jPanel3);
        jPanel3.setBounds(10, 11, 390, 79);

        jLabel5.setFont(new java.awt.Font("Tahoma", 1, 13)); // NOI18N
        jLabel5.setText("Nombre del Tipo de Notificación");
        jPanel2.add(jLabel5);
        jLabel5.setBounds(20, 90, 260, 30);

        txtNombreUpdate.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jPanel2.add(txtNombreUpdate);
        txtNombreUpdate.setBounds(10, 120, 390, 30);
        ...
        txtObservacionesUpdate.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        ...
        jScrollPane2.setBounds(10, 240, 390, 91);
