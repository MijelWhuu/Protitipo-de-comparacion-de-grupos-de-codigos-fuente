 ...
 * @author mavg
 */
public class TipoPretensiones extends javax.swing.JInternalFrame {

    SesionEntity sesion;
    TipoPretensionesBl bl = new TipoPretensionesBl();
    Utilidades u = new Utilidades();
    
    /**
     * Creates new form Destinos
     */
    public TipoPretensiones(){
        initComponents();
    }
    
    public TipoPretensiones(SesionEntity sesion) {
        this.sesion = sesion;
        initComponents();
        formatosCampos();
        mapeoTeclas();
    ...
    private void inicializaCombo(){
        u.inicializaCombo(cmbDestino, new TipoPretensionEntity(), bl.getTipoPretensiones());
    }
    ...
    private void botonF2(){
        if(jTabbedPane1.getSelectedIndex()==0){
            if(txtNombreNew.getText().length()==0){
                ...
                ErrorEntity error = bl.saveTipoPretension(new TipoPretensionEntity(txtNombreNew.getText(), txtObservacionesNew.getText(),cbxDefaultNew.isSelected()),sesion);
                if(!error.getError()){
    ...
    private void botonF4(){
        if(jTabbedPane1.getSelectedIndex()==1 && cmbDestino.getItemCount()>1){
            if(cmbDestino.getSelectedIndex()==0){
                ...
                TipoPretensionEntity tipo = (TipoPretensionEntity)cmbDestino.getSelectedItem();
                ...
                ErrorEntity error = bl.updateTipoPretension(tipo, sesion);
                if(!error.getError()){
        ...
        if(jTabbedPane1.getSelectedIndex()==1 && cmbDestino.getItemCount()>1){
            if(cmbDestino.getSelectedIndex()==0){
                ...
                if(javax.swing.JOptionPane.showInternalConfirmDialog(this, "¿Desea eliminar el elemento seleccionado?", "Alerta", 0)==0){
                    ErrorEntity error = bl.deleteTipoPretension(((TipoPretensionEntity)cmbDestino.getSelectedItem()).getId_tipo_pretension());
                    if(!error.getError()){
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("Catálogo - Tipo de Pretensiones");
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/Cat_tipo_pretensiones.jpg"))); // NOI18N
        ...
        jLabel7.setText("Nombre del Tipo de Pretensión");
        jPanel1.add(jLabel7);
        jLabel7.setBounds(20, 50, 230, 30);

        txtNombreNew.setFont(new java.awt.Font("Tahoma", 0, 13)); // NOI18N
        jPanel1.add(txtNombreNew);
        txtNombreNew.setBounds(10, 80, 420, 30);
        ...
        jScrollPane3.setBounds(10, 190, 420, 86);
        ...
        jLabel4.setText("Tipo de Pretensiones");
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addComponent(cmbDestino, javax.swing.GroupLayout.PREFERRED_SIZE, 251, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(82, 82, 82))
        );
        ...
        jPanel2.add(jPanel3);
        jPanel3.setBounds(10, 11, 420, 77);

        jLabel5.setFont(new java.awt.Font("Tahoma", 1, 13)); // NOI18N
        jLabel5.setText("Nombre del Tipo de Pretensión");
        jPanel2.add(jLabel5);
        jLabel5.setBounds(20, 90, 270, 30);

        txtNombreUpdate.setFont(new java.awt.Font("Tahoma", 0, 13)); // NOI18N
        jPanel2.add(txtNombreUpdate);
        txtNombreUpdate.setBounds(10, 120, 420, 30);
        ...
        jScrollPane2.setBounds(10, 240, 420, 86);
