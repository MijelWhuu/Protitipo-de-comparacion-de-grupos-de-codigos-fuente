 ...
 * @author mavg
 */
public class TipoDocumentosAsr extends javax.swing.JInternalFrame {

    SesionEntity sesion;
    TipoDocumentosAsrBl bl = new TipoDocumentosAsrBl();
    Utilidades u = new Utilidades();
    
    /**
     * Creates new form Destinos
     */
    public TipoDocumentosAsr(){
        initComponents();
    }
    
    public TipoDocumentosAsr(SesionEntity sesion) {
        this.sesion = sesion;
        initComponents();
        formatosCampos();
        mapeoTeclas();
    ...
    private void inicializaCombo(){
        u.inicializaCombo(cmbDestino, new TipoDocumentoAsrEntity(), bl.getTipoDocumentos());
    }
    ...
    private void botonF2(){
        if(jTabbedPane1.getSelectedIndex()==0){
            if(txtNombreNew.getText().length()==0){
                ...
                ErrorEntity error = bl.saveTipoDocumento(new TipoDocumentoAsrEntity(txtNombreNew.getText(), txtObservacionesNew.getText()), sesion);
                if(!error.getError()){
    ...
    private void botonF4(){
        if(jTabbedPane1.getSelectedIndex()==1 && cmbDestino.getItemCount()>1){
            if(cmbDestino.getSelectedIndex()==0){
                ...
                TipoDocumentoAsrEntity tipo = (TipoDocumentoAsrEntity)cmbDestino.getSelectedItem();
                tipo.setNombre(txtNombreUpdate.getText());
                tipo.setObservaciones(txtObservacionesUpdate.getText());
                ErrorEntity error = bl.updateTipoDocumento(tipo, sesion);
                if(!error.getError()){
        ...
        if(jTabbedPane1.getSelectedIndex()==1 && cmbDestino.getItemCount()>1){
            if(cmbDestino.getSelectedIndex()==0){
                ...
                if(javax.swing.JOptionPane.showInternalConfirmDialog(this, "¿Desea eliminar el elemento seleccionado?", "Alerta", 0)==0){
                    ErrorEntity error = bl.deleteTipoDocumento(((TipoDocumentoAsrEntity)cmbDestino.getSelectedItem()).getId_tipo_documento_asr());
                    if(!error.getError()){
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("Catálogo - Tipo de Documentos");
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/Cat_tipo_documento_asr.jpg"))); // NOI18N
        ...
        jLabel7.setText("Nombre del Tipo de Documento");
        jPanel1.add(jLabel7);
        jLabel7.setBounds(20, 30, 250, 30);

        txtNombreNew.setFont(new java.awt.Font("Tahoma", 0, 13)); // NOI18N
        jPanel1.add(txtNombreNew);
        txtNombreNew.setBounds(10, 60, 450, 30);

        jLabel8.setFont(new java.awt.Font("Tahoma", 1, 13)); // NOI18N
        jLabel8.setText("Observaciones");
        jPanel1.add(jLabel8);
        jLabel8.setBounds(10, 100, 134, 30);
        ...
        jScrollPane3.setBounds(10, 130, 450, 86);
        ...
        jLabel4.setText("Tipo de Documentos");
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addComponent(cmbDestino, javax.swing.GroupLayout.PREFERRED_SIZE, 250, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel2.add(jPanel3);
        jPanel3.setBounds(10, 11, 450, 80);

        jLabel5.setFont(new java.awt.Font("Tahoma", 1, 13)); // NOI18N
        jLabel5.setText("Nombre del Tipo de Documento");
        jPanel2.add(jLabel5);
        jLabel5.setBounds(20, 90, 250, 30);

        txtNombreUpdate.setFont(new java.awt.Font("Tahoma", 0, 13)); // NOI18N
        jPanel2.add(txtNombreUpdate);
        txtNombreUpdate.setBounds(10, 120, 450, 30);

        jLabel6.setFont(new java.awt.Font("Tahoma", 1, 13)); // NOI18N
        jLabel6.setText("Observaciones");
        jPanel2.add(jLabel6);
        jLabel6.setBounds(10, 150, 134, 30);
        ...
        jScrollPane2.setBounds(10, 180, 450, 86);
