 ...
 * @author mavg
 */
public class ListadoNotificacionesBl {

    public ListadoNotificacionesBl() {}
    ...
    public Boolean reporteToPDF(String archivo, String ubicacion, Integer anio, Integer mes){
        Boolean error;
        try{ 
            Connection con = new ConexionMySql().getConexionBD();
            Map params = new HashMap();
    ...
    public void reporteVisualizar(String archivo, Integer anio, Integer mes){
        try{
            Connection con = new ConexionMySql().getConexionBD();
            Map params = new HashMap();
            params.put("anio", anio);
    ...
    public void reporteImprimir(String archivo, Integer anio, Integer mes){
        try{
            Connection con = new ConexionMySql().getConexionBD();
            Map params = new HashMap();
            params.put("anio", anio);
